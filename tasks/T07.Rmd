...
3. (2 points) Create a plot that shows snotel stations with colors indicating the interval of elevation, and size of point varying by snow depth. Use only terra plot, and add legends for both color and size
