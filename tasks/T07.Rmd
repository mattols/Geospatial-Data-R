...
5. (2 points) Create a new variable for the HUC4 code, based on the HUC8 codes. Dissolve the spatial vector into HUC4 units. Then create a map plot showing all HUC8 watersheds (dashed line), with HUC4 watershed overlayed (solid line). Add text for each HUC4 unit. Add color and other arguments to enhance the map plot.
