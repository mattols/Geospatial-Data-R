...
Linear regression can be performed using the `lm()` function and the line may be added with `abline()`. Adding this part is not required as we will go over it in more detail next week.
