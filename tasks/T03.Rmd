...
After reading in the data, convert dates column to a date object and change the column names to more useful manageable names using `colnames()`. Precipitation and Snow Water Equivalent units are in inches.
...
- swe - snow water equivalent (see above)
- swe_med - historical median snow water equivalent value for 1991-2020
- depth - snow depth in inches
- prec_accum - 
- prec_accum_med - historical median prec_accum value for 1991-2020

Respond to the following questions:

7. Use the equation above to estimate the density of the snowpack each day, add this as a new column to your DataFrame. List the maximum, minimum, average, and standard deviation of the snow density (*in percent*).
...
14. Create a new DataFrame that is a subset your data based on the date when the storm arrived (*i.e. the day new snow started accumulating*). Only keep data after this date. Run another linear model on the subset of data and report similar statistics

15. Assess the relationship between snow density and minimum temperature and any other variables you think might relate to one another. Describe any patterns you notice in your initial analysis of this dataset.
